...
public class ResolveIntent {
	...
	public static void mainTest(String[] args) throws IOException, FileNotFoundException {
		...
		for (String apkfile : apkFiles) {
			...
			for (String[] items : reader.readAll()) {
				...
				for (int i = 1; i < items.length; i++) {
					...
					if (Results.intent != null && Results.intent.getAction() != null) {
