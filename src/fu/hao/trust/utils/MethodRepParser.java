...
/**
 * handles conversion from the string representation of SootMethod to our internal format {@link soot.jimple.infoflow.data.MethodRep}
 *
 */
public class MethodRepParser {
	
	private static final MethodRepParser instance = new MethodRepParser();
	
	private Pattern patternSubsigToName = null;
	
	private MethodRepParser() {
		
	}
	
	public static MethodRepParser v() {
		return instance;
	}
	 ...
	 */
	public MethodRep parseSootMethodString(String parseString){
        ...
        return new MethodRep(name, className, returnType, paramList);
