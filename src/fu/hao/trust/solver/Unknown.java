...
/**
 * @ClassName: Unknown
 * @Description: Representation of a unknown variable and its value is
 *               primitive.
 * @author: Hao Fu
...
public class Unknown extends SymbolicVar {
	...
	public Unknown(DalvikVM vm, ClassInfo type) {
		...
		if (type == null || type.isPrimitive()
				|| type.toString().contains("lang.String")
				|| type.fullName.contains("lang.CharSequence")) {
			store = new Store();
	...
	public static Object genInstance(DalvikVM vm, ClassInfo type) {
		// This is one way.
		// another way is to return null for any reflecable instance, let the
		// invoker itself to init the instance
